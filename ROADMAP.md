# 🚀 Floor Escape: Deluxe Edition — İnkişaf Yol Xəritəsi (Roadmap)

Bu sənəd oyunu daha dinamik, maraqlı və asılılıq yaradan (addictive) etmək üçün nəzərdə tutulmuş 5 əsas inkişaf mərhələsini əks etdirir.
...
1. **🛡️ Enerji Qalxanı (Aegis Shield):**
   - Oyunçunun ətrafında fırlanan parıldayan kiber-halqa.
   - Oyunçu 1 dəfə lavaya toxunarsa və ya canavarın hücumuna məruz qalarsa, qalxan partlayaraq oyunçunu yuxarı itələyir və canını xilas edir.
2. **⏱️ Zaman Ləngiməsi (Matrix / Chrono Shift):**
   - 3.5 saniyə ərzində bütün dünyanı (lavanın qalxmasını, canavarın animasiyasını) 70% yavaşladır.
   - Oyunçu normal sürətlə hərəkət edərək çətin vəziyyətdən çıxa bilir.
   - Ekranda xüsusi xromatik aberrasiya və zəif göy neon dalğalanma effekti yaranır.
3. **🚀 Kvant Sıçrayışı (Hyper Jump / Jet Trampoline):**
   - Götürüldüyü anda oyunçuya yuxarıya doğru güclü reaktiv impuls verir (təxminən 1 qat yuxarı tullayır).
4. **🧲 Super-Vakuum Maqniti (Magnet Storm):**
   - 5 saniyə ərzində ekrandakı bütün qızılları və almazları birbaşa oyunçunun üzərinə çəkir.
